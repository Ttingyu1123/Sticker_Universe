  ...
  return (
    <div className={`hud-panel p-4 w-full h-auto md:h-[calc(100vh-140px)] md:overflow-y-auto flex flex-col gap-6 transition-all duration-300 ${disabledClass}`}>
      ...
      <div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-1 gap-2">
          ...
          >
            ...
            <span className="font-semibold text-xs">Eraser</span>
          </button>
      ...
      <div className="flex-1 flex flex-col gap-6">
        ...
        <div className="bg-slate-50 p-4 rounded-xl border border-slate-100">
          <div className="flex items-center justify-between mb-3">
            <label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">
              {toolMode === 'magic-wand' ? 'Tolerance' : 'Size'}
            </label>
        ...
        {/* Background */}
        <div>
          <label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-2 block">Background</label>
      ...
      <div className="mt-auto flex flex-col gap-3 pt-6 border-t border-slate-100">
        <div className="grid grid-cols-2 gap-2">
          <button onClick={onUndo} disabled={!canUndo || !hasImage} className="p-2 bg-slate-50 hover:bg-white border border-slate-100 rounded-xl disabled:opacity-30 disabled:hover:bg-slate-50 active:scale-95 transition-all text-slate-600" title="Undo">
            <Undo2 size={18} className="mx-auto" />
          </button>
          <button onClick={onRedo} disabled={!canRedo || !hasImage} className="p-2 bg-slate-50 hover:bg-white border border-slate-100 rounded-xl disabled:opacity-30 disabled:hover:bg-slate-50 active:scale-95 transition-all text-slate-600" title="Redo">
