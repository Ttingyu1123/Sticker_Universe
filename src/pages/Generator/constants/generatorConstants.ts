...
export const TWELVE_GRID_CATEGORIES = [
    {
        ...
        items: [
            ...
            { label: '扳機社超燃（Studio Trigger Anime Explosion）', prompt: 'Transform the character into Studio Trigger anime style, intense action poses, dramatic speedlines, explosive effects, 12 sticker scenes like anime battle frames' },
            { label: '劇情截圖風（Reaction Screenshot Style）', prompt: 'Design 12 LINE stickers as if they are screenshots from an anime episode, cinematic framing, dramatic subtitles in English or Chinese, strong storytelling moments' },
            { label: '運動畫面熱血（Anime Sports Hype Moment）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，運動番熱血風格，角色像比賽中爆發瞬間，台灣慣用語繁體中文呈現，文字排版像體育轉播字幕，姿勢動感強烈，每張如高潮分鏡' },
            { label: '料理對決番（Anime Cooking Battle）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，料理對決動畫風格，角色像在做浮誇料理戰鬥，台灣慣用語繁體中文呈現，文字排版像必殺菜名字幕，每張如熱血美食番' },
        ]
    },
    {
        categoryName: '浪漫戀愛風',
        items: [
            ...
            { label: '春日戀愛微光風（Romantic Blossom Anime）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，浪漫春日戀愛動畫風格，櫻花飄落與柔焦光暈，角色害羞告白、心動轉身，台灣慣用語繁體中文呈現，文字像少女漫畫旁白字幕，構圖夢幻吸睛，每張如戀愛動畫名場面' },
            { label: '夢境星空浪漫風（Dreamy Night Sky Romance）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，夢境星空浪漫動畫風格，夜晚柔藍光與星星閃爍，角色靜靜想念、溫柔擁抱，台灣慣用語繁體中文呈現，文字像詩意旁白，每張如劇場版溫柔鏡頭' },
            { label: '甜點系戀愛可愛風（Sweet Dessert Romance）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，甜點戀愛動畫風格，馬卡龍粉彩與糖霜光澤，角色抱著草莓蛋糕、撒嬌微笑，台灣慣用語繁體中文呈現，文字像甜甜的告白台詞，每張如可愛戀愛番外篇' },
            { label: '小小告白劇情風（Soft Confession Moments）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，溫柔告白劇情動畫風格，角色露出害羞表情、遞出小花或信，台灣慣用語繁體中文呈現，文字像戀愛動畫台詞，構圖簡潔留白，每張如心動瞬間分鏡' },
            { label: '蜂蜜戀愛泡泡風（Honey Love Mood）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，蜂蜜般甜蜜戀愛動畫風格，柔金色光暈與愛心泡泡環繞，角色撒嬌、害羞、輕輕擁抱，台灣慣用語繁體中文呈現，文字排版像溫柔告白字幕，每張如戀愛動畫甜蜜名場面' },
            { label: '草莓牛奶初戀風（Strawberry First Love）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，草莓牛奶初戀動畫風格，粉白柔霧配色與春日甜香氛圍，角色臉紅、偷看、心動微笑，台灣慣用語繁體中文呈現，文字像少女漫畫旁白，每張如初戀心跳分鏡' },
            { label: '情侶日常小劇場風（Couple Cozy Moments）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，情侶日常甜蜜小劇場動畫風格，角色一起吃點心、牽手散步、互相鬧脾氣又和好，台灣慣用語繁體中文呈現，文字排版像動畫對話字幕，每張如戀愛番外篇' },
            { label: '心動告白信件風（Love Letter Scene）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，戀愛情書動畫風格，角色拿著信封、小花束、偷偷告白，柔焦光暈與紙張手繪質感，台灣慣用語繁體中文呈現，文字像情書句子，每張如告白劇情高潮' },
            { label: '甜點夢幻下午茶風（Tea Party Romance）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，夢幻下午茶戀愛動畫風格，馬卡龍、蛋糕與花朵背景，角色捧著甜點微笑撒嬌，台灣慣用語繁體中文呈現，文字排版像甜甜的邀約，每張如浪漫下午茶動畫場景' },
            { label: '小動物助攻戀愛風（Animals Blessing Love）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，吉卜力小動物助攻戀愛風格，角色被貓咪、兔子、小鳥圍繞，浪漫祝福氣氛濃厚，台灣慣用語繁體中文呈現，文字像幸福小旁白，每張如童話戀愛鏡頭' },
            { label: '星光擁抱甜蜜風（Starry Hug Scene）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，星光擁抱甜蜜動畫風格，夜晚柔藍星點與輕光包圍，角色輕輕抱抱、想念、說晚安，台灣慣用語繁體中文呈現，文字像詩意情話字幕，每張如劇場版溫柔高潮' },
            { label: '戀愛害羞小表情包（Blushing Cute Romance）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，戀愛害羞表情包動畫風格，角色臉紅捂臉、偷笑、心跳加速，背景充滿小愛心與粉色光點，台灣慣用語繁體中文呈現，文字短句可愛，每張如心動反應名場面' },
            { label: '幸福新婚童話風（Fairytale Wedding Sweetness）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，幸福童話新婚甜蜜動畫風格，角色穿著浪漫元素服飾與花環，氣氛像童話結局，台灣慣用語繁體中文呈現，文字排版像祝福台詞，每張如最甜結尾分鏡' },
        ]
    },
    {
        categoryName: '溫馨療癒風',
        items: [
            ...
            { label: '療癒系低飽和（Lo-fi Chill Mood Stickers）', prompt: 'Reference character in lo-fi chill aesthetic, muted colors, cozy sleepy expressions, minimalist captions, 12 stickers like lo-fi animation stills, soft calm vibe' },
            { label: '日本廣告吉祥物風（Japanese Soft Commercial Mascot）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，日本商業吉祥物風格，角色圓潤親切帶治癒感，台灣慣用語繁體中文呈現，文字排版像便利商店宣傳語，每張像溫馨動畫廣告分鏡' },
            { label: '雲朵貼紙風（Dreamy Cloud Stickercore）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，雲朵Stickercore夢幻風格，角色像漂浮在柔軟雲裡，台灣慣用語繁體中文呈現，文字排版像天空小標籤，療癒感爆棚' },
            { label: '嬰兒繪本萌（Ultra Soft Baby Picture Book）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，嬰兒繪本柔軟可愛風格，角色表情超純真，台灣慣用語繁體中文呈現，文字排版像睡前故事句子，治癒感極強' },
            { label: '領養海報萌（Cute Pet Adoption Poster）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，寵物領養海報風格，角色像動物之家宣傳主角，台灣慣用語繁體中文呈現，文字排版像可愛公告，療癒又吸粉' },
            { label: '治癒系日常小幸福（Cozy Slice-of-Life）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，吉卜力式治癒日常動畫風格，溫暖柔光與手繪筆觸，角色在生活小場景中微笑、發呆、抱著小物，台灣慣用語繁體中文呈現，文字排版像動畫字幕，每張如溫馨日常分鏡' },
            { label: '森林精靈童話風（Whimsical Forest Spirit）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，吉卜力森林精靈童話風格，柔和水彩背景與小動物陪伴，角色像在森林裡冒險與祝福，台灣慣用語繁體中文呈現，文字排版像故事書字幕，每張如童話動畫片段' },
            { label: '雨天溫柔陪伴風（Rainy Day Comfort）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，吉卜力雨天溫柔陪伴動畫風格，小雨傘與濕潤街道的柔光氛圍，角色安慰、守候、輕聲說話，台灣慣用語繁體中文呈現，文字排版像安靜字幕，每張如療癒電影片段' },
        ]
    },
    {
        categoryName: '搞笑迷因風',
        items: [
            ...
            { label: '短影片大字幕潮（CapCut Meme Subtitle Core）', prompt: 'Design 12 LINE stickers based on the reference character, CapCut meme subtitle style, bold oversized text, high-energy expressions, cinematic reaction moments, clean white background, social-media viral vibe' },
            { label: '國際迷因梗（Meme Cat/Dog Caption Style）', prompt: 'Create 12 meme-style LINE stickers from the reference character, exaggerated expressions, bold Impact-style captions in English, funny internet humor vibe' },
            { label: '亂畫感爆紅（Handwritten Chaos Doodle Stickers）', prompt: 'Reference character in chaotic handwritten doodle style, messy funny expressions, scribble text captions, 12 stickers like viral indie cartoon memes' },
            { label: '漫畫氣泡混亂（Comic Sticker Speech Chaos）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，漫畫氣泡混亂風格，多重對話框與吐槽文字，台灣慣用語繁體中文呈現，排版像吵鬧動畫場景，誇張又爆笑' },
            { label: '大理石雕像梗（Luxury Marble Sculpture Meme）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，大理石雕像奢華梗圖風格，角色像藝術雕塑卻在講廢話，台灣慣用語繁體中文呈現，文字排版像博物館標牌，反差感超吸睛' },
            { label: '綜藝復古字幕（Retro TV Variety Show Caption）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，復古綜藝節目字幕風格，角色像被主持人吐槽，台灣慣用語繁體中文呈現，文字排版像綜藝大字報，爆笑吸睛' },
            { label: '爆紅反應宇宙（Ultimate Viral Reaction Multiverse）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，終極爆紅反應包宇宙風格，角色集合所有情緒誇張姿勢，台灣慣用語繁體中文呈現，文字排版像社群迷因合集，每張都是動畫名場面等級，變化最豐富吸睛' },
        ]
    },
    {
        categoryName: '潮流時尚風',
        items: [
            ...
            { label: '潮牌塗鴉（Streetwear Graffiti Sticker Pack）', prompt: 'Design 12 LINE stickers with the reference character in streetwear graffiti style, bold spray typography, urban hype aesthetic, anime-meets-skate culture, energetic poses' },
            { label: '新國潮可愛風（Neo-Chinese Pop Cute）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，新國潮可愛風格，融合東方圖案與現代潮流配色，台灣慣用語繁體中文呈現，文字排版像潮流包裝設計，角色動作誇張，吸睛又獨特' },
            { label: '動態模糊反應包（Cinematic Blur Motion Reaction）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，動態模糊Motion Blur潮流風格，角色像突然衝出去或震驚瞬間，台灣慣用語繁體中文呈現，文字排版像短影音截圖，節奏超強吸睛' },
            { label: '貼紙爆炸滿版風（Sticker Bomb Maximalism）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，Sticker Bomb滿版潮流風格，構圖塞滿小元素與誇張裝飾，台灣慣用語繁體中文呈現，文字像街頭貼紙拼貼，姿勢變化極多，視覺衝擊強' },
            { label: '霓虹線框icon（Glow Outline Neon Icon）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，霓虹線框icon潮流風格，角色以發光輪廓呈現，台灣慣用語繁體中文呈現，文字排版像夜店招牌字幕，姿勢動感強烈，吸睛度爆表' },
            { label: '全息棱鏡潮流（Holographic Prism Pop）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，全息棱鏡Holographic潮流風格，角色表面帶彩虹折射光澤，台灣慣用語繁體中文呈現，文字排版像潮流包裝燙金標籤，姿勢誇張閃耀，吸睛度極強' },
            { label: '街拍閃光燈潮（Neon Street Photography Flash）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，霓虹街拍閃光燈風格，角色像夜生活抓拍瞬間，台灣慣用語繁體中文呈現，文字排版像潮流街拍標題，超酷吸睛' },
        ]
    },
    {
        categoryName: '科幻遊戲風',
        items: [
            ...
            { label: '科技emoji霓虹感（Cyber Emoji Glow）', prompt: 'Create 12 neon cyber emoji stickers from the reference character, glowing outlines, futuristic UI text, techno meme style, short English phrases like "LOL" "AFK" "BRUH"' },
            { label: '遊戲狀態貼圖（Chibi RPG Status Effect Pack）', prompt: 'Reference character as chibi RPG character stickers, 12 status effects like "HP LOW" "STUNNED" "LEVEL UP", game UI typography, anime emoji vibe' },
            { label: '玻璃感UI潮流（Neo-Transparent Glassmorphism）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，玻璃感Glassmorphism潮流風格，半透明UI質感與柔光邊緣，台灣慣用語繁體中文呈現，文字排版像未來手機介面浮動字幕，姿勢變化豐富，極具設計感' },
            { label: '復古像素介面風（Retro Pixel UI Sticker）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，復古像素遊戲UI風格，角色像8-bit動畫角色，台灣慣用語繁體中文呈現，文字排版像遊戲提示框與狀態欄，每張像RPG劇情事件' },
            { label: '恐怖遊戲介面萌（Cute Horror Game UI）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，可愛恐怖遊戲UI風格，角色像驚悚遊戲裡的萌系主角，台灣慣用語繁體中文呈現，文字排版像任務提示框，反差感爆紅' },
            { label: '扁平圖標系統（Super Flat Icon System）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，超扁平icon系統設計風格，角色像App圖示般高度簡化，台灣慣用語繁體中文呈現，文字排版像功能按鈕標籤，現代感極強' },
            { label: '科幻控制面板（Cute Sci-Fi Control Panel）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，科幻控制面板UI風格，角色像太空艙內的操作員，台灣慣用語繁體中文呈現，文字排版像系統提示訊息，每張如未來動畫劇情' },
            { label: 'VHS復古科幻（Sci-Fi Retro Anime VHS）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，VHS復古科幻動畫風格，畫面帶掃描線與舊電視質感，台灣慣用語繁體中文呈現，文字排版像80年代動畫字幕，潮流復古吸睛' },
            { label: 'AR彈窗未來感（Futuristic AR Popup Sticker）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，AR彈窗未來介面風格，角色像從螢幕跳出的提示角色，台灣慣用語繁體中文呈現，文字排版像系統通知彈窗，科技感強烈又可愛' },
            { label: '太空任務徽章（Cute Space Mission Patch）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，太空任務徽章Patch風格，角色像NASA吉祥物，台灣慣用語繁體中文呈現，文字排版像任務代號標籤，每張如太空動畫番外篇' },
        ]
    },
    {
        categoryName: '藝術插畫風',
        items: [
            ...
            { label: '拼貼文青（Pinterest Sticker Collage Aesthetic）', prompt: 'Design 12 LINE stickers in Pinterest collage aesthetic, layered paper textures, cute doodles, reference character integrated with trendy typography, soft modern layout' },
            { label: '紙雕拼貼風（Paper Cut Collage）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，紙雕拼貼藝術風格，層層紙張材質與手作質感，台灣慣用語繁體中文呈現，文字排版像手帳貼紙，姿勢活潑多變，每張像童話動畫場景' },
            { label: '極簡線稿梗句（Minimal Line Art + Punchline）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，極簡線稿插畫風格，角色用最少線條呈現但表情到位，台灣慣用語繁體中文呈現，文字像一句梗Punchline，排版俐落時髦，適合爆款貼圖' },
            { label: '美術館超現實（Surreal Museum Art Sticker）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，超現實美術館藝術風格，角色像出現在畫框中的奇幻人物，台灣慣用語繁體中文呈現，文字排版像展覽標籤，劇情感獨特高級' },
            { label: '書法潮流混搭（Luxury Calligraphy Brush Pop）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，書法筆刷潮流混搭風格，角色搭配潑墨筆觸與動態字體，台灣慣用語繁體中文呈現，文字像帥氣書法招式名，每張如武俠動畫必殺技' },
            { label: '美術館海報字排（Museum Poster Typography）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，美術館海報字排風格，角色像展覽主視覺人物，台灣慣用語繁體中文呈現，文字排版像現代藝術展標題，構圖高級極簡，吸睛又獨特' },
            { label: '中世紀手抄本萌（Cute Medieval Manuscript）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，中世紀手抄本插畫風格，角色像古書邊角的可愛小怪物，台灣慣用語繁體中文呈現，文字排版像古卷註解，荒謬又吸睛' },
            { label: '手作拼貼風（Cute DIY Craft Sticker）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，DIY手作拼貼風格，像剪紙與貼紙手帳作品，台灣慣用語繁體中文呈現，文字排版像手寫便利貼，溫暖可愛超耐看' },
        ]
    },
    {
        categoryName: '商業可愛風',
        items: [
            ...
            { label: '皮克斯誇張表情（Pixar Reaction Face Style）', prompt: 'Reference character transformed into Pixar-style expressive sticker pack, 12 unique poses, exaggerated facial emotions, cinematic lighting, playful typography in English, meme-worthy reactions' },
            { label: 'Hello Kitty爆款可愛（Sanrio Kawaii Pop）', prompt: 'Turn the reference character into Sanrio-inspired kawaii style, pastel colors, soft outlines, 12 cute LINE stickers, sweet expressions, playful short English captions' },
            { label: '果凍團子風（Cute Blob Character Trend）', prompt: 'Turn the reference character into a cute blob mascot style, squishy proportions, funny bouncing poses, 12 stickers with simple viral captions, ultra trendy kawaii meme' },
            { label: '柔霧噴槍風（Dreamy Soft Airbrush Style）', prompt: 'Reference character in dreamy soft airbrush illustration style, smooth gradients, glossy highlights, delicate emotions, 12 stickers like modern aesthetic emojis' },
            { label: '潮流公仔風（3D Toy Figure Stickers）', prompt: 'Turn the reference character into a designer toy figure style, 3D collectible look, cute big head proportions, 12 stickers with fun English catchphrases' },
            { label: '高級極簡 (Apple-like)（Luxury Minimal Emoji）', prompt: 'Create 12 ultra-minimal luxury emoji-style stickers, reference character simplified, clean outlines, subtle typography, modern premium aesthetic, short captions only' },
            { label: '柔軟立體表情包（Soft 3D Emoji Core）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，柔軟3D emoji風格，角色像手機貼圖般圓潤立體，台灣慣用語繁體中文呈現，文字短句搭配動作表情，構圖簡潔但吸睛，每張像社群反應包' },
            { label: '粉彩介面簡約（Cute Minimal Pastel UI）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，粉彩UI極簡風格，角色像app介面中的可愛小助手，台灣慣用語繁體中文呈現，文字排版像按鈕標籤，乾淨又流行' },
        ]
    },
    {
        categoryName: '台灣日常風',
        items: [
            { label: '上班族爆紅梗（Cute Office Meme Style）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，上班族迷因風格，角色像社畜日常動畫，台灣慣用語繁體中文呈現，文字排版像辦公室便利貼吐槽，劇情感強烈，每張都像職場名場面' },
            { label: '療癒食物系（ASMR Cozy Foodie Sticker）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，ASMR療癒食物系風格，角色在吃喝或抱著食物，台灣慣用語繁體中文呈現，文字像甜點包裝小標籤，畫面溫暖可愛超流行' },
            { label: '課本邊角塗鴉風（Notebook Margin Doodle）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，課本邊角塗鴉風格，像學生隨手畫的小劇場角色，台灣慣用語繁體中文呈現，文字像筆記旁的吐槽註解，構圖自由可愛，青春感爆棚' },
            { label: '底片快照復古（Film Camera Snapshot Retro）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，底片相機快照復古風格，帶顆粒與閃光燈效果，台灣慣用語繁體中文呈現，文字排版像拍立得日期標註，每張像青春動畫回憶片段' },
            { label: '咖啡廳菜單風（Cute Café Menu Sticker）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，咖啡廳菜單插畫風格，角色搭配飲料甜點情境，台灣慣用語繁體中文呈現，文字排版像餐廳手寫菜單，溫暖又流行' },
            { label: '深夜公車氛圍（Lo-fi Night Bus Mood）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，深夜lo-fi公車氛圍風格，角色像在夜晚通勤發呆，台灣慣用語繁體中文呈現，文字排版像內心旁白字幕，療癒又有故事感' },
            { label: '教室梗圖系列（Cute Classroom Meme Pack）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，校園教室迷因風格，角色像學生上課崩潰日常，台灣慣用語繁體中文呈現，文字排版像黑板吐槽，劇情感超強爆紅' },
            { label: '珍奶流行文化（Bubble Tea Pop Culture）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，珍奶流行文化風格，角色搭配飲料杯與Q彈元素，台灣慣用語繁體中文呈現，文字排版像手搖杯封膜，超台又超可愛' },
            { label: '超商小劇場（Cute Convenience Store Drama）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，便利商店小劇場風格，角色像在7-11裡發生荒謬日常，台灣慣用語繁體中文呈現，文字排版像收據吐槽，超生活爆款' },
        ]
    },
    {
        categoryName: '高級質感風',
        items: [
            { label: '時尚雜誌貼圖（Luxury Fashion Editorial Sticker）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，高級時尚雜誌Editorial風格，角色動作像伸展台定格，台灣慣用語繁體中文呈現，文字排版像精品雜誌標題，極簡但超有質感' },
            { label: '高級日式包裝（Luxury Japanese Packaging Minimal）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，高級日式包裝設計風格，極簡留白與精緻字體排版，台灣慣用語繁體中文呈現，角色姿勢優雅，整體像精品伴手禮貼紙' },
            { label: '伸展台表情包（High Fashion Runway Reaction）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，高級時裝伸展台反應包風格，角色姿勢像時尚定格，台灣慣用語繁體中文呈現，文字排版像雜誌標題，冷酷又搞笑的反差感' },
            { label: '精品金印章（Cute Luxury Gold Stamp）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，精品金印章風格，角色搭配燙金標章與極簡高級排版，台灣慣用語繁體中文呈現，文字像精品認證標籤，質感爆棚獨特' },
            { label: '香水標籤高級（Luxury Perfume Label Style）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，高級香水標籤風格，角色搭配精品排版與留白，台灣慣用語繁體中文呈現，文字像香氛命名，極簡奢華感強烈' },
            { label: '咖啡豆包裝（Luxury Coffee Roaster Label）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，精品咖啡烘豆包裝風格，角色搭配高級字排，台灣慣用語繁體中文呈現，文字像咖啡命名標籤，文青又時髦' },
            { label: '零食包裝潮（Futuristic Neon Snack Packaging）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，未來霓虹零食包裝風格，角色像新潮洋芋片吉祥物，台灣慣用語繁體中文呈現，文字排版像商品標語，潮到爆' },
            { label: '精品霓虹招牌（Luxury Neon Sign Minimal）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，精品霓虹招牌極簡風格，角色搭配發光字體與大留白，台灣慣用語繁體中文呈現，文字排版像高級夜店招牌，極潮吸睛' },
        ]
    },
    {
        categoryName: '奇幻混搭風',
        items: [
            ...
            { label: '可愛恐怖混搭（Kawaii Horror）', prompt: '參考角色設計12款LINE貼紙，可愛恐怖混搭風，萌系外表但氣氛詭異，台灣慣用語繁體中文，文字像恐怖童話台詞，劇情反差強' },
            { label: '夢核粉彩超現實（Dreamcore Pastel Surreal）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，Dreamcore粉彩超現實風格，夢境般柔霧背景與怪奇可愛元素，台灣慣用語繁體中文呈現，文字像夢中旁白，姿勢奇幻多變，吸睛又療癒' },
            { label: '動物裝扮潮（Ultra Cute Animal Costume Cosplay）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，角色穿各種動物裝扮Cosplay潮流風格，台灣慣用語繁體中文呈現，文字排版像可愛角色標籤，每張像動畫番外篇，變化豐富超吸粉' },
            { label: '亂畫潮流崩壞可愛（Cute Chaos Scribble Pop）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，可愛混亂塗鴉潮流風格，角色線條隨性但表情超有戲，台灣慣用語繁體中文呈現，文字像手寫爆炸塗鴉，姿勢誇張超吸睛' },
            { label: '天氣預報情緒貼（Cute Weather Forecast Pack）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，天氣預報情緒風格，角色搭配晴天雨天雷暴等心情象徵，台灣慣用語繁體中文呈現，文字排版像氣象ICON提示，每張都超可愛實用' },
            { label: '家庭動畫喜劇（Wholesome Family Sitcom Style）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，家庭動畫喜劇風格，角色像情境動畫主角，台灣慣用語繁體中文呈現，文字排版像電視字幕吐槽，每張像日常劇名場面' },
            { label: '可愛塔羅神秘（Cute Tarot Card Mystic）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，可愛塔羅牌神秘風格，角色搭配占卜符號與夢幻框架，台灣慣用語繁體中文呈現，文字排版像命運旁白，每張都像魔法故事卡' },
            { label: '霓虹卡拉OK字幕（Neon Karaoke Subtitle）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，霓虹卡拉OK字幕風格，角色像在唱歌或吐槽，台灣慣用語繁體中文呈現，文字排版像跳動歌詞字幕，動作誇張歡樂，每張像音樂動畫名場面' },
            { label: '夢日記旁白（Cute Dream Journal Mood）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，夢日記情緒風格，角色像在記錄奇怪夢境，台灣慣用語繁體中文呈現，文字排版像日記旁白，療癒又超現實' },
            { label: '神話角色卡（Cute Mythology Card Set）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，可愛神話卡牌風格，角色像傳說小英雄，台灣慣用語繁體中文呈現，文字排版像技能說明，每張如動畫冒險番' },
            { label: '旅行行李貼（Cute Airport Travel Sticker Pack）', prompt: '將參考圖片的角色變形並設計12種LINE貼紙，機場旅行行李貼紙風格，角色像旅遊紀念貼，台灣慣用語繁體中文呈現，文字排版像登機證標籤，每張如旅行動畫片段' },
        ]
    },
];
