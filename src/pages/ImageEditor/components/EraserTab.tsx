...
const EraserTab: React.FC = () => {
    ...
    return (
        <div className="h-full overflow-hidden font-sans text-slate-700 bg-transparent">

            {/* Unified Main Workspace - Full Screen Layout */}
            <div className="flex-1 flex flex-col md:flex-row h-full overflow-hidden relative z-0 bg-background">
