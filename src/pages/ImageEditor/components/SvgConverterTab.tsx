...
export default function SvgConverterTab() {
    ...
    return (
        <div className="w-full h-full p-6 space-y-8 animate-in fade-in duration-500 overflow-y-auto">
            {showGallery && <GalleryPicker onSelect={handleGallerySelect} onClose={() => setShowGallery(false)} />}

            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 h-full">
                {/* Upload Section */}
                <section className="bg-white/40 backdrop-blur-md border border-cream-dark shadow-sm rounded-[2rem] p-8 flex flex-col h-fit min-h-[500px]">
                    ...
                    {!image ? (
                        <div
                            ...
                            className="flex-1 border-3 border-dashed border-cream-dark bg-cream-light/50 hover:bg-cream-medium/50 hover:border-primary rounded-[2rem] flex flex-col items-center justify-center cursor-pointer transition-all group min-h-[300px]"
                        >
                        ...
                        <div className="flex-1 relative rounded-[2rem] overflow-hidden border border-cream-dark bg-cream-light/50 p-4 flex items-center justify-center min-h-[300px]">
                ...
                <section className="bg-white/40 backdrop-blur-md border border-cream-dark shadow-sm rounded-[2rem] p-8 flex flex-col h-fit min-h-[500px]">
                    ...
                    <div className="flex-1 border border-cream-dark bg-[url('https://grainy-gradients.vercel.app/noise.svg')] bg-cream-light rounded-[2rem] overflow-hidden relative flex items-center justify-center p-8 group min-h-[300px]">
                        {!svgContent ? (
