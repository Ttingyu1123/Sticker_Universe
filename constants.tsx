...
export const FUNCTION_BUTTONS = [
  ...
  { label: '品牌視覺', prompt: '使用上傳的產品圖片，製作一張垂直版 9:16 比例的品牌設計規格海報。設計風格需貼合產品的細分市場定位與視覺標誌。海報需劃分清晰美觀的版塊，具體包含：（1）品牌標誌醒目展示及安全區域使用規範；（2）產品樣機居中突出呈現；（3）主輔色卡搭配十六進制色值標註；（4）字體規範，涵蓋標題、副標題、正文字體示例及行間距參數；（5）品牌常用圖示或圖形元素範例；（6）圖片處理風格，附生活場景或棚拍效果範例圖；（7）網格系統與版面配置規則；（8）包裝樣機及實體應用效果展示；（9）設計注意事項，搭配標註說明圖。背景採用簡約白色或柔和中性色調，輔以規則的版塊分割線及投影效果。最終成品需視覺豐富、版面整潔，適用於印刷版或電子版品牌手冊。' },
