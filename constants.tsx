...
export const FUNCTION_BUTTONS = [
    { label: '公仔手辦', prompt: '4K, create a 1/7 scale commercialized figure of the character, in a realistic style and environment. Place the figure on a computer desk, using a circular transparent acrylic base without any text. On the computer screen, display the ZBrush modeling process of the figure. Next to the computer screen, place a EANDAI-style toy packaging box printed with the original artwork' },
...
export const TWELVE_GRID_STYLES = [
  {
    "label": "熱血少年漫風（Jump感）",
  ...
  {
    "label": "Ultra Cute Animal Costume Cosplay（動物裝扮潮）",
    "prompt": "將參考圖片的角色變形並設計12種LINE貼紙，角色穿各種動物裝扮Cosplay潮流風格，台灣慣用語繁體中文呈現，文字排版像可愛角色標籤，每張像動畫番外篇，變化豐富超吸粉"
  },
  {
